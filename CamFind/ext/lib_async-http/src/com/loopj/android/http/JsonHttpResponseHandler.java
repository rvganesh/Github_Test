...
public class JsonHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public void onSuccess(JSONObject response) {
    	PrintLog.debug("JsonHttpResponse Handler","JsonHttpResponse Handler: On Success --:> "+response.toString());
...
//    	Log.e("Task","On Failure --:> "+errorResponse.toString());
    	try {
			
    		PrintLog.debug("JsonHttpResponse Handler","JsonHttpResponse Handler: on Failure--:> "+errorResponse.toString());
		} catch (Exception e2) {
			PrintLog.debug("JsonHttpResponse Handler","JsonHttpResponse Handler: on Failure--:> "+e2);
		}
    }
