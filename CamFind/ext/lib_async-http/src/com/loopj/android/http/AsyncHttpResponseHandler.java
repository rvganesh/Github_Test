...
public class AsyncHttpResponseHandler {
    ...
    public void onFailure(Throwable error, String content) {
        ...
        onFailure(error);
        PrintLog.debug("AsynHttpResponseHandler","AysncHttpResponse Handler: Task Failure:  --> Response"+content);
    }
    ...
    void sendResponseMessage(HttpResponse response) {
        ...
        }else if(status.getStatusCode() >= 300 && status.getStatusCode() != 302) {
