...
public class AsyncHttpClient {
   ...
   /**
    ...
    public void get(Context context, String url, RequestParams params, AsyncHttpResponseHandler responseHandler) {
    	PrintLog.debug("AsynHttpClient", "AsynHttpClient: Url 		--> "+url);
    	PrintLog.debug("AsynHttpClient", "AsynHttpClient: Method	--> Get");
    	PrintLog.debug("AsynHttpClient", "AsynHttpClient: Params	--> "+params);
    ...
    public void post(Context context, String url, RequestParams params, AsyncHttpResponseHandler responseHandler) {
    	PrintLog.debug("AsynHttpClient","AsynHttpClient: Url 		--> "+url);
    	PrintLog.debug("AsynHttpClient","AsynHttpClient: Method	--> Post");
    	PrintLog.debug("AsynHttpClient","AsynHttpClient: Params	--> "+params);
    ...
    public void put(Context context, String url, HttpEntity entity, String contentType, AsyncHttpResponseHandler responseHandler) {
    	PrintLog.debug("AsynHttpClient", "AsynHttpClient: Url 		--> "+url);
    	PrintLog.debug("AsynHttpClient","AsynHttpClient: Method	--> Put");
    	PrintLog.debug("AsynHttpClient","AsynHttpClient: Params	--> "+entity);
